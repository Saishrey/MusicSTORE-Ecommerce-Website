<?php 
    ...
    $query = "select * from instrument limit 9";
               ...
               <div class="why-shop">
                ...
                <div class="product-box">
                    ...
                    <div class="search-box-container">
                        <form action="">
                            <input type="search" class="form-control" placeholder="Search your favourites">
                            <select name="category" id="category" class="form-control">
                                <option style="background-color: rgb(5,29,54); color: white;" value="guitar">Guitar</option>
                                <option style="background-color: rgb(5,29,54); color: white;" value="piano">Piano</option>
                                <option style="background-color: rgb(5,29,54); color: white;" value="keyboard">Keyboard</option>
                                <option style="background-color: rgb(5,29,54); color: white;" value="drums">Drums & Percussions</option>
                                <option style="background-color: rgb(5,29,54); color: white;" value="wind">Wind instruments</option>
                            </select>
