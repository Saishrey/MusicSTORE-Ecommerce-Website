<?php 
    ...
    if(isset($_GET['instrument_id'])) {
        ...
        $array['s_id'] = $_SESSION['seller_id'];
        $array['i_id'] = $_GET['instrument_id'];

        $query_del = "delete from instrument where s_id = :s_id and inst_id=:i_id;";
        $stmnt_del = $con->prepare($query_del);
        $check_del = $stmnt_del->execute($array);

        header("Location: removeInstrument.php");
        die;
    }
?>
    ...
    <body>
        <style>
            ...
            * {
            ...
            .inst-table td form .hidden-input {
                display: none;
            }
            .inst-table td form .delete {
                text-decoration: none;
                padding: 10px 20px;
                background: #F3950D;
                border: none;
            ...
            .inst-table td form .delete:hover {
                cursor: pointer;
                background: red;
            }
            .inst-table .sr-no {
                    ...
                    <div class="main-body">
                        <div class="data">
                            ...
                            <div class="inst-up-rem">
                                <p>Click on the Delete button to remove instrument.</p>
                            </div>
                            <div class="inst-table">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form method="get">
                                                <input class="hidden-input" type="text" name="instrument_id" value="<?=$inst_data[$i]->inst_id?>">
